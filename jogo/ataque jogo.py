...
CODE_WORDS = [
 "firewall", "malware", "phishing", "exploit", "trojan",
    ...
    "injected", "relogin", "logout",  "cookies","Craker",
...
MENU_BG_CANDIDATES = [
    os.path.join(BASE_DIR, "ataque", "ataque-mapa.png"),
    os.path.join(BASE_DIR, "ataque", "gradiente-vermelho.png")
]
# ----------------------------
# Classe principal
# ----------------------------
class BaseGame:
    ...
    def load_background_images(self):
        base_dir = BASE_DIR
        try:
            world = Image.open(os.path.join(base_dir, "ataque", "ataque-mapa.png"))
        except Exception:
            world = None
        try:
            texture = Image.open(os.path.join(base_dir, "ataque", "gradiente-vermelho.png"))
        except Exception:
            texture = None
